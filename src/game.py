...
class Game:
    ...
    def initializeFields(self):
        ...
        self.fields.append(Field(name="Szansa", isSpecial=True,specialFunction=self.chanceField , imagePath="res/questionmark.png")) # Szansa
        self.fields.append(Field(name="Historia Filozofii", color=(102, 51, 0), financial=(12, 4, 12, 36, 90, 10))) # 1.2
        self.fields.append(Field(name="DUUUŻY grzyb", isSpecial=True,specialFunction=self.bigMushroom, imagePath="res/bigmush.png")) # Grzyb duży
        ...
        self.fields.append(Field(name="Naprawa komputera", isSpecial=True,specialFunction=self.prisonField, imagePath="res/jail.png")) # Więzienie
        self.fields.append(Field(name="Kurs: Podstawowy warsztat informatyka", color=(153, 0, 153), financial=(28, 10, 30, 90, 150, 20)))   # 3.1
        self.fields.append(Field(name="Praktyka zawodowa w Nokii", isSpecial=True,specialFunction=self.practiseField,financial=(45,30,0,0,0,0), imagePath="res/nokia.png")) 
        ...
        self.fields.append(Field(name="Tramwaj", isSpecial=True,specialFunction=self.tramField, imagePath="res/tram.png")) # Tramwaj
        ...
        self.fields.append(Field(name="Praktyka zawodowa w Comarch", isSpecial=True,specialFunction=self.practiseField,financial=(45,30,0,0,0,0), imagePath="res/comarch.png"))
        self.fields.append(Field(name="Języki programowania", color=(255, 255, 0), financial=(56, 24, 72, 170, 240, 30))) # 6.3
        self.fields.append(Field(name="Zepsułeś komputer", isSpecial=True,specialFunction=self.goToPrison, imagePath="res/gotojail.png")) # Idź do więzienia
        ...
        self.fields.append(Field(name="Mały grzyb", isSpecial=True,specialFunction=self.littleMushroom, imagePath="res/smallmush.png")) # Grzyb mały
